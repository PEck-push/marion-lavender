...
const C = {
  cream:"#F2EFE8", stone:"#D8D4C8", clay:"#9B8FAA", clayDeep:"#4A4560",
  moss:"#4A4560", mossMid:"#6A7A64", dust:"#C4BAD4", midnight:"#1A1530",
  white:"#FAF8F4", ink:"#24203A"
};
...
body{background:#FAF8F4;color:#24203A;font-family:'DM Sans',sans-serif;font-weight:300;line-height:1.7}
    ...
    <div style={wrap} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)} onClick={() => inp.current?.click()}>
      ...
      {img ? (
        <>
          ...
          {hov && <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: ".6rem 1rem", background: "rgba(26,21,48,.7)", backdropFilter: "blur(6px)" }}>
            <span style={{ fontSize: ".55rem", letterSpacing: ".2em", color: C.dust, textTransform: "uppercase" }}>Bild austauschen</span>
          </div>}
        </>
      ) : (
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "1.4rem", background: hov ? "rgba(155,143,170,.09)" : "transparent", transition: "background .3s" }}>
...
function Note({ children }) {
  return <div style={{ background: "rgba(155,143,170,.08)", borderLeft: `3px solid ${C.clay}`, padding: "1.3rem 1.8rem", margin: "1.8rem 0", fontSize: ".82rem", lineHeight: 1.7, color: "#35304A" }}>{children}</div>;
}
function Btn({ children, onClick, variant = "solid", light = false }) {
  const [hov, setHov] = useState(false);
  const v = {
    solid: { background: hov ? C.clayDeep : C.clay, color: C.white, border: "none" },
    outline: { background: hov ? (light ? "rgba(255,255,255,.08)" : "rgba(155,143,170,.07)") : "transparent", color: light ? C.cream : C.clay, border: `1.5px solid ${light ? C.dust : C.clay}` },
  };
  return (
  ...
  return (
    <div style={{ borderBottom: `1px solid ${C.stone}` }}>
      ...
      <div style={{ maxHeight: open ? "500px" : "0", overflow: "hidden", transition: "max-height .5s ease" }}>
        <p style={{ paddingBottom: "1.3rem", fontSize: ".87rem", color: "#4A4560", lineHeight: 1.85, paddingRight: "1.5rem" }}>{a}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ position: "relative", width: size, height: size, flexShrink: 0, pointerEvents: "none" }}>
      ...
      <div style={{
        ...
        inset: "20%",
        borderRadius: "50%",
        background: `radial-gradient(ellipse at 50% 50%, rgba(155,143,170,.05) 0%, rgba(196,186,212,.02) 40%, transparent 65%)`,
...
function SvcCard({ icon, title, desc, onClick }) {
  ...
  return (
    <div onClick={onClick} onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      ...
      <p style={{ fontSize: ".81rem", lineHeight: 1.75, color: "#4A4560", margin: 0, flexGrow: 1 }}>{desc}</p>
...
function OilCard({ name, lat, anw, kind }) {
  ...
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      ...
      <p style={{ fontSize: ".85rem", color: "#4A4560", margin: "0 0 1.2rem", lineHeight: 1.6, flexGrow: 1 }}>{anw}</p>
  ...
  return (
    <>
      ...
      <section style={{ background: C.moss, position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, background: `radial-gradient(ellipse 70% 60% at 65% 45%, rgba(155,143,170,.2) 0%, transparent 65%)`, pointerEvents: "none" }} />
        <div className="wk-hero-grid" style={{ maxWidth: "1380px", margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <div className="wk-hero-right" style={{ display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", inset: 0, background: `radial-gradient(ellipse 80% 60% at 60% 40%, rgba(196,186,212,.15) 0%, transparent 65%)`, pointerEvents: "none" }} />
      ...
      <section className="wk-section" style={{ background: C.white }}>
        <div className="wk-inner wk-2col" style={{ alignItems: "center" }}>
          <Reveal>
            ...
            <p style={{ fontSize: ".93rem", lineHeight: 1.95, color: "#4A4560", marginBottom: "1.2rem" }}>
            ...
            <p style={{ fontSize: ".93rem", lineHeight: 1.95, color: "#4A4560", marginBottom: "2rem" }}>
      ...
      <section className="wk-section" style={{ background: C.moss, position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "-10%", right: "-5%", width: "480px", height: "480px", borderRadius: "50%", border: `1px solid rgba(196,186,212,.12)`, pointerEvents: "none" }} />
      ...
      <section className="wk-section" style={{ background: C.cream, borderTop: `1px solid ${C.stone}` }}>
        <div className="wk-inner wk-2col" style={{ alignItems: "center" }}>
          <Reveal>
            ...
            <p style={{ fontSize: ".95rem", color: "#4A4560", lineHeight: 1.85, maxWidth: "420px", marginBottom: "2.5rem" }}>
            ...
            <div style={{ border: `1px solid ${C.stone}`, background: C.white }}>
              {[
                ...
                <div key={i} style={{ padding: "2rem 2.5rem", borderBottom: i < 2 ? `1px solid ${C.stone}` : "none" }}>
                  ...
                  <div style={{ fontSize: ".8rem", color: "#4A4560" }}>{item.sub}</div>
                </div>
              ))}
            </div>
          </Reveal>
    ...
    <>
      <section style={{ background: C.moss, paddingTop: "70px", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", right: 0, top: 0, bottom: 0, width: "42%", zIndex: 0 }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right,#4A4560 0%,rgba(74,69,96,.2) 100%)", pointerEvents: "none" }} />
        </div>
      ...
      <section className="wk-section"><div className="wk-inner wk-2col">
        <Reveal>
          ...
          <p style={{ fontSize: ".92rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.2rem" }}>Wenn das Baby viel weint, schlecht schläft, beim Trinken unruhig ist oder sich stark überstreckt, wächst die Sorge schnell: "Mache ich etwas falsch? Hat mein Kind Schmerzen?"</p>
          <p style={{ fontSize: ".92rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.2rem" }}>Du machst nichts falsch. Manchmal hinterlässt der Weg ins Leben — eine rasante Geburt, ein Kaiserschnitt, der Einsatz einer Saugglocke — Spannungen im winzigen Körper.</p>
          <div style={{ padding: "1.5rem 2rem", background: C.cream, borderLeft: `3px solid ${C.clay}`, marginTop: "1rem" }}>
            ...
            <p style={{ fontSize: ".82rem", color: "#4A4560", lineHeight: 1.75, margin: 0 }}>In meiner Praxis herrscht kein Zeitdruck. Wenn gestillt, gewickelt oder gekuschelt werden muss, machen wir Pause.</p>
          </div>
        </Reveal>
        <Reveal delay={0.2}>
      ...
      <section className="wk-section-s" style={{ background: C.cream }}><div className="wk-inner">
        <Reveal><Label n="02" text="Wann kommen Familien zu mir" /><H2>Was Eltern häufig berichten.</H2>
          <p style={{ fontSize: ".88rem", color: "#4A4560", lineHeight: 1.85, maxWidth: "620px", marginBottom: "2rem" }}>Die craniosacrale Therapie ist eine ergänzende Methode — kein Ersatz für ärztliche Diagnosen.</p>
        </Reveal>
            ...
            <Reveal key={g.g} delay={i * 0.12} style={{ height: "100%" }}>
              <div style={{ padding: "2.3rem 1.8rem", height: "100%" }}>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                  {g.items.map(it => (
                    <li key={it} style={{ fontSize: ".84rem", color: "#4A4560", padding: ".4rem 0", borderBottom: `1px solid ${C.stone}`, lineHeight: 1.5 }}>
      ...
      <section className="wk-section-s" style={{ background: C.moss }}><div style={{ maxWidth: "680px", margin: "0 auto" }}>
        <Reveal>
          ...
          <div style={{ border: `1px solid rgba(216,212,200,.2)`, marginTop: "2rem" }}>
            {[["Erstbehandlung Säugling (60 min)", "€ 75,–"], ["Folgebehandlung (45 min)", "€ 60,–"], ["Erstbehandlung Kleinkind / Erwachsener", "€ 80,–"], ["CST + Tuina kombiniert", "€ 85,–"]].map(([l, p], i) => (
              <div key={i} style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", alignItems: "center", padding: "1.1rem 1.8rem", borderBottom: "1px solid rgba(216,212,200,.15)", background: i % 2 === 0 ? "rgba(255,255,255,.03)" : "transparent" }}>
    ...
    <>
      ...
      <section className="wk-section"><div className="wk-inner wk-2col">
        <Reveal>
          ...
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.2rem" }}>Mit einfachen, alltagstauglichen Rezepten — wärmende Kraftsuppen, spezielle Porridges — füllen wir deine Speicher auf, unterstützen den Milchfluss und helfen dem Körper, das Erschöpfungs-Plateau nach der Geburt zu überwinden.</p>
        ...
        <Reveal delay={0.2}>
          ...
          {[
            ...
            <div key={i} style={{ padding: "1rem 0", borderBottom: `1px solid ${C.stone}` }}>
              ...
              <p style={{ fontSize: ".82rem", color: "#4A4560", margin: 0, lineHeight: 1.75 }}>{s.d}</p>
            </div>
          ))}
        </Reveal>
      </div></section>
    ...
    <>
      ...
      <section className="wk-section"><div className="wk-inner wk-2col">
        <Reveal>
          ...
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.2rem" }}>Als ausgebildete Kursleitung gebe ich Eltern konkrete Griffe mit, die sie täglich zu Hause anwenden können — ein echtes Werkzeug für den Alltag, das die Bindung stärkt.</p>
      ...
      <div className="wk-inner wk-2col" style={{ marginTop: "4rem", paddingTop: "4rem", borderTop: `1px solid ${C.stone}` }}>
        ...
        <Reveal delay={0.2}>
          ...
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.5rem" }}>Besonders für Mütter, deren Schulter-Nacken-Bereich durch Tragen und Stillen verspannt ist, bietet das sanfte Trocken-Schröpfen spürbare Erleichterung.</p>
          {["Löst tiefe Muskelverspannungen und Faszienverklebungen.", "Fördert die lokale Durchblutung.", "Ergänzt die Tuina-Behandlung wirkungsvoll."].map((s, i) => (
            <div key={i} style={{ display: "flex", gap: "1rem", padding: ".75rem 0", borderBottom: `1px solid ${C.stone}`, fontSize: ".82rem", color: "#4A4560", lineHeight: 1.7 }}>
    ...
    <>
      ...
      <section className="wk-section"><div className="wk-inner wk-2col">
        <Reveal>
          ...
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.5rem" }}>Der G-Well Pointer lokalisiert Akupunkturpunkte und Triggerpunkte durch Messung des Hautwiderstands und stimuliert sie mit sanften mikroelektrischen Impulsen — vollständig schmerzfrei.</p>
          {[{ n: "01", t: "Absolut schmerzfrei", d: "Ideal für alle, die Angst vor Nadeln haben." }, { n: "02", t: "Narbenentstörung nach Kaiserschnitt", d: "Besonders wirksam bei Narbengewebe — relevant für Mütter nach Kaiserschnitt." }, { n: "03", t: "Direkte Entspannung", d: "Wirkung bei stark verspanntem Nacken- und Schulterbereich." }].map(s => (
            <div key={s.n} style={{ padding: "1.1rem 1.4rem", background: C.cream, borderLeft: `3px solid ${C.clay}`, marginBottom: ".8rem" }}>
              ...
              <p style={{ fontSize: ".78rem", color: "#4A4560", margin: 0, lineHeight: 1.7 }}>{s.d}</p>
            </div>
          ))}
        </Reveal>
    ...
    <>
      ...
      <section className="wk-section"><div className="wk-inner wk-2col">
        <Reveal>
          ...
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1rem" }}>
    ...
    <>
      <section className="wk-about-hero" style={{ background: C.moss }}>
        ...
        <div style={{ position: "relative", minHeight: "420px" }}>
          ...
          <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right,rgba(74,69,96,.35) 0%,transparent 40%)", pointerEvents: "none" }} />
        </div>
      </section>
      <section className="wk-section"><div className="wk-inner wk-2col">
        <Reveal>
          ...
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.1rem" }}>Mein Weg zur craniosakralen Therapie begann mit der Faszination für die Weisheit des menschlichen Körpers. Jeder Mensch — vom ersten Atemzug an — trägt die Fähigkeit zur Selbstregulation in sich.</p>
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560", marginBottom: "1.1rem" }}>Als ehemalige Leiterin der Kinderstation des Krankenhauses Eisenstadt habe ich Tausende von Kindern begleitet und Familien in den schwierigsten Momenten ihres Lebens gestützt.</p>
          <p style={{ fontSize: ".9rem", lineHeight: 1.9, color: "#4A4560" }}>In meiner Praxis in Mattersburg biete ich einen geschützten Raum — einen Raum, in dem Erschöpfung sein darf, Tränen fließen dürfen und wir gemeinsam die Wurzeln für ein gesundes Wachstum stärken.</p>
        </Reveal>
        <Reveal delay={0.2}>
          ...
          {quals.map((q, i) => (
            <div key={i} style={{ padding: ".9rem 0", borderBottom: `1px solid ${C.stone}`, display: "flex", gap: "1rem" }}>
              ...
              <div>
                ...
                <div style={{ fontSize: ".74rem", color: "#4A4560", lineHeight: 1.6 }}>{q.s}</div>
              </div>
            </div>
          ))}
        </Reveal>
...
function Navbar({ current, nav }) {
  ...
  return (
    <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: scrolled || open ? "rgba(250,248,244,.97)" : "rgba(250,248,244,.88)", backdropFilter: "blur(14px)", borderBottom: `1px solid rgba(155,143,170,${scrolled ? .2 : .08})`, transition: "all .3s" }}>
    ...
    <footer style={{ background: C.midnight, padding: "4.5rem clamp(1.4rem,5vw,5rem) 2.5rem" }}>
      <div className="wk-footer-g" style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div>
          ...
          <p style={{ fontSize: ".8rem", lineHeight: 1.85, color: "rgba(216,212,200,.7)", maxWidth: "300px" }}>Spezialisierte Craniosacral Therapie für Säuglinge und Kleinkinder. TCM · Tuina · G-Well · Aromatherapie. Mattersburg, Burgenland.</p>
        </div>
        <div>
          ...
          {[["cranio", "Craniosakrale Energetik"], ["tcm", "TCM Ernährung"], ["tuina", "Tuina & Massagetechniken"], ["schmerz", "G-Well Pointer"], ["aroma", "Aromatherapie"], ["uebermich", "Über mich"]].map(([id, l]) => (
            <button key={id} onClick={() => nav(id)} style={{ display: "block", background: "none", border: "none", fontSize: ".78rem", color: "rgba(216,212,200,.65)", padding: ".3rem 0", fontFamily: "'DM Sans',sans-serif", textAlign: "left", transition: "color .2s" }}
              onMouseEnter={e => e.target.style.color = C.clay} onMouseLeave={e => e.target.style.color = "rgba(216,212,200,.65)"}>{l}</button>
          ))}
        </div>
        <div>
          ...
          <div style={{ display: "flex", gap: ".6rem", flexWrap: "wrap" }}>
            {[["Anrufen", "tel:+436503631969"], ["WhatsApp", "https://wa.me/436503631969"]].map(([l, h]) => (
              <button key={l} onClick={() => window.open(h)} style={{ background: "transparent", border: `1px solid rgba(196,186,212,.3)`, color: C.dust, padding: ".55rem 1.1rem", fontSize: ".58rem", letterSpacing: ".2em", textTransform: "uppercase", fontFamily: "'DM Sans',sans-serif", transition: "border-color .2s" }}
                onMouseEnter={e => e.currentTarget.style.borderColor = C.dust} onMouseLeave={e => e.currentTarget.style.borderColor = "rgba(196,186,212,.3)"}>{l}</button>
            ))}
          </div>
        </div>
      </div>
      <div style={{ maxWidth: "1200px", margin: "2.5rem auto 0", paddingTop: "1.8rem", borderTop: "1px solid rgba(255,255,255,.06)", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", fontSize: ".58rem", color: "#555", letterSpacing: ".1em" }}>
